...
- – settlement: trade orders are concluded between the maker and the takerover the Lightning Network;
...
On the other hand, trade takers face the issue of lazy or malicious coun- terparties who refuse to honor their issued trade orders by not entering into Bitcoin escrow contracts. Furthermore, trade participants may exhibit a low level of cooperation by not settling operations off-chain, thus burdening their counterparties with on-chain fees.
